...
st.set_page_config(layout="wide", page_title="Novus Campus Beta 1.0", page_icon="🧑‍🎓")

st.title('Novus Campus 🧑‍🎓 Beta 1.0')
st.header("Sistemas Inteligentes de Aprendizaje")
st.write("Bienvenidos al futuro educativo 👋")
st.markdown(
  """
  En esta web encontrarás los 3 sistemas iniciales de Novus Campus 🎓:
...
st.title('Sistema de Diagnóstico Personalizado 📊')
...
st.title('Sistema de Hoja de Ruta de Aprendizaje con Calendario Personalizada 📆')
...
st.title('Sistema de Evaluación Personalizada con Videollamadas Automatizadas 🧠')
